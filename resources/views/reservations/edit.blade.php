...
<div class="form-group">
    ...
    <input type="date" class="form-control" id="return_date" name="return_date" value="{{ $reservation->return_date->format('Y-m-d') }}" required>
</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="is_returned" name="is_returned"
                                        {{ $reservation->is_returned ? 'checked' : '' }}>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="user_id" name="user_id"
                                        value="{{ $reservation->user_id }}" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="book_id" name="book_id"
                                        value="{{ $reservation->book_id }}" disabled>
                                </div>
