...
<head>
    ...
    <link href="{{ asset('dash-assets/css/sb-admin-2.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{ asset('dash-assets/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('dash-assets/vendor/chart.js/Chart.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('dash-assets/js/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('dash-assets/js/demo/chart-pie-demo.js') }}"></script>
