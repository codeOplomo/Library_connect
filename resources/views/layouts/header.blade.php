...
<body class="bg-gray-100">
    ...
    <nav class="bg-white shadow-lg">
        <div class="max-w-6xl mx-auto px-4">
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    <div>
                        ...
                        <a href="{{ url('/') }}" class="flex items-center py-4 px-2">
                            <img src="{{ asset('img/code-zero-sail.jpg') }}" alt="Logo" class="h-8 w-8 mr-2">
                            <span class="font-semibold text-gray-500 text-lg">BookyGo</span>
                        </a>
                    </div>
                    <!-- Primary Navbar items -->
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="{{ url('/') }}" class="py-4 px-2 {{ Request::is('/') ? 'text-green-500 border-b-4 border-green-500 font-semibold' : 'text-gray-500' }}">Home</a>
                ...
                <div class="hidden md:flex items-center space-x-3 ">
                    <a href="{{ url('/auth/login') }}" class="py-2 px-2 font-medium text-gray-500 rounded hover:bg-green-500 hover:text-white transition duration-300">Log In</a>
                    <a href="{{ url('/auth/signup') }}" class="py-2 px-2 font-medium text-white bg-green-500 rounded hover:bg-green-400 transition duration-300">Sign Up</a>
                </div>
                <!-- Mobile menu button -->
        ...
        <div class="hidden mobile-menu">
            <ul>
                <li><a href="/" class="block text-sm px-2 py-4 {{ Request::is('/') ? 'text-white bg-green-500 font-semibold' : 'hover:bg-green-500 transition duration-300' }}">Home</a></li>
